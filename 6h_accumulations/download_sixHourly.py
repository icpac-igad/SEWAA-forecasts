...
IFS_data_dir = "/home/c/cooperf/IFS/ICPAC_data/operational/grib_historical"
...
file_name = f"{IFS_data_dir}/{date_str}_{time_str}Z_pl700_54h.grib"
...
# Where to store the pressure level data
file_name = f"{IFS_data_dir}/{date_str}_{time_str}Z_sfc_54h.grib"
...
# Where to store the pressure level data
file_name = f"{IFS_data_dir}/{date_str}_{time_str}Z_MUCAPE_54h.grib"
