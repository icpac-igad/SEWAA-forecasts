...
if __name__ == "__main__":
    ...
    # Trackio project to log this run under. Keep truth sources in separate projects:
    # CRPS on CHIRPS is not comparable to CRPS on RFE2. Defaults to the RFE2 project so
    # the existing RFE2 configs keep logging to their own history.
    trackio_project = setup_params["SETUP"].get("trackio_project", "sewaa-cgan-rfe2")
